...
\begin{document}
    ...
    \section{Linki i bibliografia}
        ...
        \bibitem{8} James Kurose, Keith Ross, "Computer networking a top-down approach", Pearson, 2017
        \bibitem{9} Kevin Fall, Richard Stevens, "TCP/IP Illustrated", Addison-Wesley, 20122
        \end{thebibliography}
